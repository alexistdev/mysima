<x-admin.template-admin :title="$judul" :menu-utama="$menuUtama" :menu-kedua="$menuKedua">
    ...
    <section role="main" class="content-body">
        <header class="page-header page-header-left-breadcrumb">
            ...
            <h2 class="font-weight-semibold">Edit Data Mahasiswa</h2>
        </header>

        <!-- start: page -->
        <div class="row">
            <div class="col-lg-12 mb-3">
                <form action="{{route('adm.mahasiswa.update')}}" class="form-horizontal form-bordered" method="post">
                    @csrf
                    @method('patch')
                    <section class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <input type="hidden" name="user_id" value="{{old('user_id',$dataMahasiswa->mahasiswa->user_id)}}">
                                        </div>
                                    </div>
                                    <div class="form-group row pb-4">
                                        <label
                                            class="col-lg-3 control-label text-lg-end pt-2 @error('nim') text-danger @enderror"
                                            for="nim">NIM <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="text" name="nim"
                                                   class="form-control @error('nim') is-invalid @enderror"
                                                   value="{{old('nim',$dataMahasiswa->mahasiswa->nim)}}" id="nim">
                                            @error('nim')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" id="email"
                                                       ...
                                                       value="{{old('email',$dataMahasiswa->email)}}" placeholder="contoh: email@email.com"/>
                                            </div>
                                            @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="form-group row pb-4">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="name"
                                                   ...
                                                   value="{{old('name',$dataMahasiswa->name)}}" id="name">
                                            @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row pb-4">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="phone"
                                                   ...
                                                   value="{{old('phone',$dataMahasiswa->mahasiswa->phone)}}" id="phone">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <textarea type="text" name="alamat"
                                                   class="form-control @error('alamat') is-invalid @enderror"
                                                      id="alamat">{{old('alamat',$dataMahasiswa->mahasiswa->alamat)}} </textarea>
                                            @error('alamat')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
