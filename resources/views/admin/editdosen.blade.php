<x-admin.template-admin :title="$judul" :menu-utama="$menuUtama" :menu-kedua="$menuKedua">
    ...
    <section role="main" class="content-body">
        <header class="page-header page-header-left-breadcrumb">
            ...
            <h2 class="font-weight-semibold">Edit Data Dosen</h2>
        </header>

        <!-- start: page -->
        <div class="row">
            <div class="col-lg-12 mb-3">
                <form action="{{route('adm.dosen.update')}}" class="form-horizontal form-bordered" method="post">
                    @csrf
                    @method('patch')
                    <section class="card">
                        <header class="card-header">

                            <h2 class="card-title">FORM EDIT DOSEN</h2>
                        </header>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <input type="hidden" name="user_id" value="{{old('user_id',$dataDosen->user_id)}}">
                                        </div>
                                    </div>
                                    <div class="form-group row pb-4">
                                        <label
                                            class="col-lg-3 control-label text-lg-end pt-2 @error('nik') text-danger @enderror"
                                            for="nik">NIK <span class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <input type="text" name="nik"
                                                   class="form-control @error('nik') is-invalid @enderror"
                                                   value="{{old('nik',$dataDosen->nik)}}" id="nik">
                                            @error('nik')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" id="email"
                                                       ...
                                                       value="{{old('email',$dataDosen->user->email)}}" placeholder="contoh: email@email.com"/>
                                            </div>
                                            @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="form-group row pb-4">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="name"
                                                   ...
                                                   value="{{old('name',$dataDosen->user->name)}}" id="name">
                                            @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row pb-4">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="phone"
                                                   ...
                                                   value="{{old('phone',$dataDosen->phone)}}" id="phone">
                                            @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <textarea type="text" name="alamat"
                                                   class="form-control @error('alamat') is-invalid @enderror"
                                                      id="alamat">{{old('alamat',$dataDosen->alamat)}} </textarea>
                                            @error('alamat')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
